...
To be structured:
            ...
            *[Work and careers - RMIT University](http://www.rmit.edu.au/careers)
            *[Getting started · Jasny Bootstrap](http://jasny.github.io/bootstrap/getting-started/)
            *[Transfer your Spotify Playlists to Google MusicMaui Mauer](http://www.maui.at/2013/06/portify/)
            *[Live.js - One script closer to Designing in the Browser](http://livejs.com/)
...
To be structured:
            ...
            *[text wrangler to java - Google Search](https://www.google.com.au/search?aq=f&sugexp=chrome,mod=19&sourceid=chrome&ie=UTF-8&q=text+wrangler+to+java)
            ...
            *[textwrangler – anoved.net](http://anoved.net/tag/textwrangler/)
            *[Beginner Java Programmer Question - MacRumors Forums](http://forums.macrumors.com/showthread.php?t=1304090)
            *[Creating Java Programs in Gordon&#39;s Macintosh Lab Using the OSX Command Line](http://www.math-cs.gordon.edu/courses/UsingJavaInMacLab/CommandLine/UsingJavaInMacLab-CL.html)
            *[Welcome to NetBeans](http://netbeans.org/)
            *[Xcode 4 Downloads and Resources - Apple Developer](https://developer.apple.com/xcode/)
            ...
            *[MC062 Master of Computing - RMIT University](http://www.rmit.edu.au/browse;ID=gvc5d8cl9q2i)
